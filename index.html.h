...
<body>
  <img src='img/nekomezaka.gif' width='200px' style='position:absolute;top:0;right:0' onclick='nekome()'>

  <div id='poster'>
    <div class='icons'>
      <img alt='icon' title='枚方&#x0A;cympfh' src='./img/identicon.png' height='96px' onclick='show()'>
      &nbsp;
    ...
    <center>
      <a class='shortcut' href='taglibro/top.html'>▼</a>
  </center>
  </div>
